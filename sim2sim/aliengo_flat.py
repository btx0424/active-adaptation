...
class FixedCommandFlat(CommandManager):
    command_dim = 4
    ...
    def update(self):
        self.command[0] = self.speed_x
        self.command[1] = self.speed_y
        self.command[2] = self.yaw_vel
