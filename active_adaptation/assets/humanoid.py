...
G1_WAIST_UNLOCKED_CFG = ArticulationCfg( # no wrist pitch and yaw
    ...
    actuators={
        "base_legs": ImplicitActuatorCfg(
            ...
            stiffness={
                ".*_hip_yaw_joint": 2.0 * STIFFNESS_7520_14,
                ".*_hip_roll_joint": STIFFNESS_7520_22,
                ".*_hip_pitch_joint": 2.0 * STIFFNESS_7520_14,
                ".*_knee_joint": STIFFNESS_7520_22,
                ".*ankle.*": 4.0 * STIFFNESS_5020,
            ...
            damping={
                ".*_hip_pitch_joint": 2.0 * DAMPING_7520_14,
                ".*_hip_roll_joint": DAMPING_7520_22,
                ".*_hip_yaw_joint": 2.0 * DAMPING_7520_14,
                ".*_knee_joint": DAMPING_7520_22,
                ".*ankle.*": 4.0 * DAMPING_5020,
